...
if __name__ == "__main__":
    ...
    parser.add_argument("--is_unlabel", default = False, action="store_true", help="unlabeled setup")
    parser.add_argument("--verbose", default = True, action="store_true", help="print a datapoint")
