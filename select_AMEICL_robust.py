...
from metaicl.model_robust import MetaICLModel
...
tokenizer = GPT2Tokenizer.from_pretrained(args.model_path, cache_dir="cached")
checkpoint = None
...
def run(logger, num_class, options, metaicl_data, metaicl_model, train_data, eval_data, seed,
    ...
    probs = metaicl_model.do_inference(args.rob_bound, metaicl_data, args.test_batch_size, verbose=False) 
